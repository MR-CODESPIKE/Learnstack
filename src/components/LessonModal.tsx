...
import { X, CheckCircle, Clock, BookOpen, Terminal, Sparkles, ArrowRight } from 'lucide-react';
        ...
        <div className="p-6 sm:p-8 space-y-6 max-h-[75vh] overflow-y-auto">
                  ...
                  return (
                    <div key={idx} className="my-3 rounded-lg overflow-hidden border border-[#D6C5B3] bg-[#FAF4ED]">
                      <div className="px-3 py-1.5 bg-[#EFE5D9] text-[11px] font-mono text-[#6E5D4F] border-b border-[#D6C5B3] flex justify-between items-center">
                        <span className="font-semibold text-[#8C4A1B]">python • Sample Code</span>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => {
                  onSendToPlayground(lesson.initialCode);
                  onClose();
                }}
